...
def generate_launch_description():
    ...
    wheeltec_robot_dir = get_package_share_directory('agv_bringup')
    ...
    map_dir = os.path.join(wheeltec_robot_dir, 'maps')
    map_file = LaunchConfiguration('map', default=os.path.join(
        map_dir, 'map_last.yaml'))
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [wheeltec_launch_dir, '/base.launch.py']),
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [wheeltec_launch_dir, '/sllidar.launch.py']),
        ),        
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
